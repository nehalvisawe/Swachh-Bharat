    ...
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-200 tracking-tight">
          Swachh-Bharat <span className="text-green-600">Waste Management</span>
        </h1>
      ...
      <section className="bg-gray-500 p-10 rounded-3xl shadow-lg mb-20">
...
function FeatureCard({ icon: Icon, title, description }: { icon: React.ElementType; title: string; description: string }) {
  return (
    <div className="bg-gray-500 p-8 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 ease-in-out flex flex-col items-center text-center">
      <div className="bg-green-100 p-4 rounded-full mb-6">
        <Icon className="h-8 w-8 text-green-600" />
      </div>
      <h3 className="text-xl font-semibold mb-4 text-gray-50">{title}</h3>
      <p className="text-gray-50 leading-relaxed">{description}</p>
    </div>
  )
}